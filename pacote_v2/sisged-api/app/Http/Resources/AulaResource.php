...
class AulaResource extends JsonResource
{
    public function toArray(Request $request): array
    {
        return [
            ...
            'turma' => $this->whenLoaded('turma', fn () => $this->turma?->codigoTurma),
            'instrutores' => $this->whenLoaded('instrutores', fn () => $this->instrutores->pluck('nomeInstrutor')),
            'salas' => $this->whenLoaded('salas', fn () => $this->salas->pluck('nomeSala')),
        ];
    }
}
